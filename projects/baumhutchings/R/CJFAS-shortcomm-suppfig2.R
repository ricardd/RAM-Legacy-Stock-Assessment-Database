...
pdf("CBD-Supp-fig2_v1.pdf", height=8, width=6)
...
mtext.fun(xstring="Discontinuous pre-1992",ystring="Drift pre-1992",xline=2.5,yline=2)
plot(par.estimates.1010$m.slope.after, par.estimates.1010$mss.slope.after, xlab="", ylab=""); abline(c(0,1))
mtext.fun(xstring="Discontinuous post-1992",ystring="Drift post-1992",xline=2.5,yline=2)
plot(par.estimates.1010$mcont.slope.before, par.estimates.1010$mss.slope.before, xlab="", ylab=""); abline(c(0,1))
mtext.fun(xstring="Continuous pre-1992",ystring="Drift pre-1992",xline=2.5,yline=2)
plot(par.estimates.1010$mcont.slope.after, par.estimates.1010$mss.slope.after, xlab="", ylab=""); abline(c(0,1))
mtext.fun(xstring="Continuous post-1992",ystring="Drift post-1992",xline=2.5,yline=2)
dev.off()

system("xpdf CBD-Supp-fig2_v1.pdf")
