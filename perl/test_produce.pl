...
# Time-stamp: <2009-03-11 13:47:10 (mintoc)>
use strict;
use warnings;
use DBI;
use LaTeX::Table;
...
my $temptex="/home/srdbadmin/SQLpg/srDB/tex/templates/test_template.tex";
my $outtex="/home/srdbadmin/SQLpg/srDB/tex/" . $assessorid . "_test_QAQC.tex";
...
print OUT '\includepdf[angle=90]{/home/srdbadmin/SQLpg/srDB/tex/lme_map.pdf}';
...
my $outpdffile = "/home/srdbadmin/SQLpg/srDB/tex/" . $assessorid . "_first_page.pdf";
## clean up, removes extra files generated by latex
my $outtexlog= "/home/srdbadmin/SQLpg/srDB/tex/" . $assessorid . "_first_page.log";
my $outtexaux= "/home/srdbadmin/SQLpg/srDB/tex/" . $assessorid . "_first_page.aux";
my $outtexout= "/home/srdbadmin/SQLpg/srDB/tex/" . $assessorid . "_first_page.out";
#unlink $outtex, $outtexlog, $outtexaux, $outtexout || die "Cannot open file";

#----------------
my $alloutpdffile="/home/srdbadmin/SQLpg/srDB/tex/" . $assessorid . "-QAQC" . ".pdf";
my $lmepdf="";
my $pdflist0=join(" ", @pdflistarray);
my $pdflist= "$outpdffile" . " $pdflist0" ;
my $gscommand=("/usr/bin/gs". " -dBATCH". " -dNOPAUSE". " -q". " -sDEVICE=pdfwrite". " -sOutputFile=$alloutpdffile". " $pdflist");
#print "$gscommand\n";
my @gscall=`$gscommand`;
#print "@gscall\n";
#system(@gscall);
