...
\subsection*{Summary}
\noindent
Total number of proper stocks assessments: 334, from 298 marine fish populations and 36
...
Top 5 taxonomic orders: Gadiformes (n=70), Perciformes (n=65), Pleuronectiformes (n=54), Scorpaeniformes (n=43), Clupeiformes (n=36) \\
...
Statistical catch-at-age/length models (n=171), Virtual Population Analyses (n=92) and
...
\noindent
Number of assessments from NMFS: 141 (80 with reference points, 41 (51 \%) are below $B_{msy}$, 63 (79 \%) are below $U_{msy}$, ) \\
...
California Current (n=36), Gulf of Alaska (n=29),
New Zealand Shelf (n=29), Celtic-Biscay Shelf (n=26), East Bering Sea (n=21)
