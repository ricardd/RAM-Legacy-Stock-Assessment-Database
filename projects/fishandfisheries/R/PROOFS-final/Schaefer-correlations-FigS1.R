...
## last modified Time-stamp: <2011-08-04 12:25:01 (srdbadmin)>
...
my.table.contingency <- xtable(contingency.table, caption=my.caption, label=c("tab:contingency"), digits=2, align="ccc")
  print(my.table.contingency, type="latex", file="../../tex/PROOFS-final/Table-S2.tex", include.rownames=TRUE, floating=TRUE, caption.placement="bottom") #, sanitize.text.function=I)

  print(my.table.contingency, type="html", file="../../tex/PROOFS-final/Table-S2.html", include.rownames=TRUE, floating=TRUE, caption.placement="bottom") #, sanitize.text.function=I)
...
my.table.contingency.kbound5maxb <- xtable(contingency.table.kbound5maxb, caption=my.caption, label=c("tab:contingency"), digits=2, align="ccc")
  print(my.table.contingency.kbound5maxb, type="latex", file="../../tex/PROOFS-final/Table-S2-kbound5maxb.tex", include.rownames=TRUE, floating=TRUE, caption.placement="bottom") #, sanitize.text.function=I)

  print(my.table.contingency.kbound5maxb, type="html", file="../../tex/PROOFS-final/Table-S2-kbound5maxb.html", include.rownames=TRUE, floating=TRUE, caption.placement="bottom") #, sanitize.text.function=I)
