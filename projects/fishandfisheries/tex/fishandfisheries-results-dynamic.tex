...
trophic level of assessed species ranged from REF:SQL:MINTL to
REF:SQL:MAXTL with a mean of REF:SQL:MEANTL (Figure~\ref{fig:TL}).
...
(REF:SQL:PERCENTVPAICES\% of assessments), DFO
(REF:SQL:PERCENTVPADFO\% of assessments) and Argentina's CFP
(REF:SQL:PERCENTVPACFP\% of assessments), whereas statistical
catch-at-age and -length models are more common for NMFS
(REF:SQL:PERCENTSCALNMFS\% of assessments), AFMA
(REF:SQL:PERCENTSCALAFMA\% of assessments) and MFish
(REF:SQL:PERCENTSCALMFISH\% of assessments).
