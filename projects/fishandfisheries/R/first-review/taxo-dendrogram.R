...
## pdf output
pdf("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/FishBase-byorder.pdf", width=10, height=10)
...
pdf("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/SAUP-byorder.pdf", width=10, height=10)
...
pdf("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/srdb-by-assessment.pdf", width=10, height=10, title="Taxonomic dendrogram of RAM Legacy database")
#png("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/srdb-by-assessment.png", width=1000, height=1000)
...
pdf("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/srdb-byorder.pdf", width=10, height=10)
...
pdf("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/srdb-fishonly-byorder.pdf", width=10, height=10)
plot(taxo.phylo.srdb, type="r", no.margin = TRUE, cex=0.8, root.edge=TRUE, show.tip.label=TRUE,
     edge.width=taxo.2.phylo.srdb$div.edge.length, label.offset=0.5, srt=0, adj=0)
points(0,0, col=1, pch=21, bg="darkgrey", cex=3)
text(0.26,0.16,labels=paste("Actinopterygii",paste("(",percent.actinopterygii,")", sep=""), sep="\n"))
...
pdf("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/fishbase_saup_two_panel_phylo.pdf", width=10, height=6)
...
pdf("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/three-panel-phylo.pdf", width=6, height=10)
#png("/home/srdbadmin/srdb/projects/fishandfisheries/R/first-review/three_panel_phylo.png", width=600, height=1000)
