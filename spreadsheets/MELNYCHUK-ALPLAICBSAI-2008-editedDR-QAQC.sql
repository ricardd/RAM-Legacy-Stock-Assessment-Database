BEGIN;
 ...
 INSERT INTO srdb.bioparams VALUES('AFSC-ALPLAICBSAI-1972-2008-MELNYCHUK','M-1/yr','0.25', 'result of previous assessment profiling; may range from 0.195 for males to 0.27 for females', 'NULL') ; 
 INSERT INTO srdb.bioparams VALUES('AFSC-ALPLAICBSAI-1972-2008-MELNYCHUK','MAX-AGE-yr','25', 'oldest ages found in trawl surveys', 'NULL') ; 
 INSERT INTO srdb.bioparams VALUES('AFSC-ALPLAICBSAI-1972-2008-MELNYCHUK','Fmsy-1/yr','0.62', 'note, the value in the table on p.1 of the assessment is switched with F40%', 'NULL') ; 
 INSERT INTO srdb.bioparams VALUES('AFSC-ALPLAICBSAI-1972-2008-MELNYCHUK','NATMORT-1/yr','0.25', 'result of previous assessment profiling; may range from 0.195 for males to 0.27 for females', 'NULL') ; 
 INSERT INTO srdb.bioparams VALUES('AFSC-ALPLAICBSAI-1972-2008-MELNYCHUK','F40%-1/T','0.86', 'note, the value in the table on p.1 of the assessment is switched with Fmsy', 'NULL') ; 
