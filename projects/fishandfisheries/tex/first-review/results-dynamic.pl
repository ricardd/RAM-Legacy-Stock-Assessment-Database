...
# original, DR CM
# current DR
# Last modified Time-stamp: <2011-02-01 23:10:45 (srdbadmin)>
use strict;
use warnings;
use DBI;
...
open OUT, ">/home/srdbadmin/srdb/projects/fishandfisheries/tex/first-review/results-dynamic.tex" or die $!;

open IN, "/home/srdbadmin/srdb/projects/fishandfisheries/tex/first-review/fandf-results-dynamic.tex" or die $!;
