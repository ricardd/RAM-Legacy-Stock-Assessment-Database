...
tt.taxocategory,
gg.geo,
ts.stockid, aa.areaname, ss.stocklong, ta.commonname1, ta.scientificname, ts.assessid, ts.tsyear, ts.ssb
...
#stocklist.1010 <- unique(data.frame(area=as.character(dat.1010$geo[oo]),scientificname=as.character(dat.1010$scientificname[oo]), stockid=as.character(dat.1010$stockid[oo]),stocklong=as.character(dat.1010$stocklong[oo])))
