%% Last modified: Time-stamp: <2010-06-29 15:37:44 (srdbadmin)>
%%\documentclass[letterpaper,12pt]{article}
\documentclass[letterpaper,review,authoryear,12pt]{elsarticle}
...
SR pair) over the period from 1995-2005. The assessment results
collated by Dr. Myers were used to:
...
estimated, for all stock assessments and by management body. To
...
world's major fisheries.  Comparisons between assessments and catch
data at a regional level are hampered by the geographic mismatch
between stocks and FAO statistical areas or the SAUP's Large Marine
Ecosystems.
...
RODBC \citep{R:RODBC}, KernSmooth \citep{R:KernSmooth}, gregmisc
\citep{R:gregmisc}, xtable \citep{R:xtable}, ape \citep{R:ape}, gsubfn
\citep{R:gsubfn}, IDPmisc \citep{R:IDPmisc}, and doBy \citep{R:doBy}.
Figure~\ref{fig:lmes} was generated using the Generic Mapping Tools
\citep{gmt}.

%% , beanplot \citep{R:beanplot}
%%%%%%%%%%%%%%%%%%%%%%%%%
%% Results
%%%%%%%%%%%%%%%%%%%%%%%%% 
...
relatively short time series of most assessments..)  -what are the
...
\subsubsection*{Current status of assessed fisheries}
...
strength of conclusions drawn may be weakened.  The original database
developed by Ransom A. Myers was used to address a variety of ecological
questions derived from stock-recruit relationships. This was possible
because the VPA-type assessment models that comprised most of that
database generated time series of stock and recruitment with relatively
few a priori assumptions.  Forward projection methods generally
specify the form of the stock-recruit relationship, and in many cases
even fix parameters (infinitely dense point prior) such as steepness.
Stock-recruitment ``data'' from such models, are clearly inappropriate
for straightforward meta-analysis. More generally, meta-analysis may
become the victim of its own success.  As more assessments incorporate
some type of prior information from other stocks or species
...
for conducting and making available the stock assessments that form
