BEGIN;
 INSERT INTO srdb.assessment VALUES('ADFG-HERRSITKA-1978-2007-COLLIE', 'ADFG', 'HERRSITKA', 'COLLIE', '2008-12-08', '2010-12-02 20:31:06', '1978-2007', 'received from Contact', 'Peter-John Frederick Hulson, p.hulson@uaf.edu', 'The data are from ADF&G - Pete did the assessment as part of his M.S.', '', 1, 0, 'AD-CAM', 'no comments', '../spreadsheets/COLLIE-HERRSIT-2007-editedOJ.xls') ; 
 ...
 INSERT INTO srdb.bioparams VALUES('ADFG-HERRSITKA-1978-2007-COLLIE','MAT-MODEL-option','Logisitc', 'Parameters for logistic function of maturity-at-age estimated', 'NULL') ; 
 ...
 INSERT INTO srdb.bioparams VALUES('ADFG-HERRSITKA-1978-2007-COLLIE','Fecundity-N','AVAILABLE', 'Estimated from survey, 1971-2007', 'NULL') ; 
 INSERT INTO srdb.bioparams VALUES('ADFG-HERRSITKA-1978-2007-COLLIE','Fecundity-rel-eggs/g','AVAILABLE', 'Measured several times since 1971', 'NULL') ; 
 INSERT INTO srdb.bioparams VALUES('ADFG-HERRSITKA-1978-2007-COLLIE','M-1/yr','0.3-0.1', 'Estimated as parameter, split in 1998', 'NULL') ; 
