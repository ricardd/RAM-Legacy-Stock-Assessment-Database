...
## Last modified: Time-stamp: <2011-08-04 10:52:51 (srdbadmin)>
...
# MFish
fried.egg.fct("mgmt",c("('MFish')"),"MFish","FALSE","TRUE","c","TRUE")

# AFMA
fried.egg.fct("mgmt",c("('AFMA')"),"AFMA","FALSE","FALSE","d","TRUE")
