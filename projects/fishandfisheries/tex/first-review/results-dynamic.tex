...
Top 5 taxonomic orders: Gadiformes (n=70), Perciformes (n=65), Pleuronectiformes (n=53), Scorpaeniformes (n=41), Clupeiformes (n=36) \\
...
\noindent
Number of assessments from NMFS: 138 (79 with reference points, 40 (51 \%) are below $B_{msy}$, 62 (78 \%) are below $U_{msy}$, ) \\
...
Number of assessments from DFO: 26 (15 with reference points, 13 (87 \%) are below $B_{msy}$, 14 (93 \%) are below $U_{msy}$, ) \\
