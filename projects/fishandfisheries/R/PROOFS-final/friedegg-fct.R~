## last modified Time-stamp: <2011-08-04 10:57:00 (srdbadmin)>
...
## Table S1 with BibTex \ref
  print(my.table.S2.withref, type="latex", file="../../tex/PROOFS-final/Table-S1-withref.tex", include.rownames=FALSE, floating=FALSE, tabular.environment="longtable", caption.placement="bottom", sanitize.text.function=I)
