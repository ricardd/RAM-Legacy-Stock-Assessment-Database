...
# Time-stamp: <2010-07-14 16:09:40 (srdbadmin)>
...
#  my @systemcall=("/usr/bin/perl", "/home/srdbadmin/SQLpg/srDB/perl/srDB-QAQCv0.2.pl", "$_");
  my @systemcall=("/usr/bin/perl", "/home/srdbadmin/srdb/perl/srDB-QAQCv1.0.pl", "$_");

#  my @systemcall=("/usr/bin/perl", "/home/srdbadmin/srdb/perl/srDB-QAQCv0.2.pl", "$_");
  system(@systemcall);
#  push(@pdflistarray, "/home/srdbadmin/SQLpg/srDB/tex/" . $_ . ".pdf");
  push(@pdflistarray, "/home/srdbadmin/srdb/tex/" . $_ . ".pdf");
}
...
print OUT '\includepdf[angle=90, addtotoc={1,subsubsection,1,LME map,lmemap}]{/home/srdbadmin/srdb/tex/lme_map.pdf}';
...
my $outtexlog= "/home/srdbadmin/srdb/tex/" . $argument . "_QAQC.log";
my $outtexaux= "/home/srdbadmin/srdb/tex/" . $argument . "_QAQC.aux";
my $outtexout= "/home/srdbadmin/srdb/tex/" . $argument . "_QAQC.out";
