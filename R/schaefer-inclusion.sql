...
-- Last modified Time-stamp: <2011-01-18 12:47:08 (srdbadmin)>
...
-- keep the stocks listed above for the final srdb.spfits table
DELETE FROM srdb.spfits_schaefer WHERE assessid not in (
'NWFSC-COWCODSCAL-1900-2007-BRANCH',
...
'SEFSC-VSNAPSATLC-1946-2008-STANTON',
...
'NWFSC-BGROCKPCOAST-1950-2005-STANTON',
...
'NWFSC-LSTHORNHPCOAST-1962-2005-STANTON',
...
'NZMFishDEEPWATER-BLACKOREOWECR-1973-2007-JENSEN',
...
'NZMFishMIDDEPTHSWG-GEMFISHNZ-1952-2007-JENSEN',
