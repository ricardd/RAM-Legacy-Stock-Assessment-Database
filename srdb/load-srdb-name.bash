...
# Last modified: Time-stamp: <2011-07-25 10:56:41 (srdbadmin)>

psql -d $1 -f './scripts/load-stocks.sql'

psql -d $1 -f './scripts/RAM-tables.sql'

psql -d $1 -f './scripts/load-assessors.sql'
psql -d $1 -f './scripts/load-assessmethods.sql'

# indices 
psql -d $1 -f './scripts/indices.sql'
