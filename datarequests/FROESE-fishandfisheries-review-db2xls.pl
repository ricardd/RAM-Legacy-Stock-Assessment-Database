...
# Daniel Ricard
# Started: 2010-08-31
# Time-stamp: <2010-09-01 11:25:40 (srdbadmin)>
...
my $workbook = Spreadsheet::WriteExcel->new("FROESE-fishandfisheries-RAMLegacy.xls");

# Add 4 worksheets
$workbook->compatibility_mode();
$workbook->set_properties(
title    => 'This is a single spreadsheet containing the table contents from the RAM Legacy database. Sent to Rainer Froese for review of the Fish and Fisheries manuscript',
...
$sheet0->write(0, 0, "Single spreadsheet of the RAM Legacy database, created for Rainer Froese.");
