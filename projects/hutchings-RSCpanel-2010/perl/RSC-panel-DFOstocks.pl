#!/usr/bin/perl -w
# a Perl script to generate a single pdf file containing summaries and plots for all DFO assessments in the database
# Daniel Ricard, started 2010-03-25
# Time-stamp: <2010-03-25 13:42:23 (srdbadmin)>
use strict;
use warnings;
use DBI;
use LaTeX::Table;
...
open LATEXFILE, ">../tex/RSC-DFOstocks.tex" or die $!;
...
srdb.taxonomy tt, srdb.assessor a
WHERE
a.mgmt = \'DFO\' AND
...
my $sqlfam = qq{SELECT distinct tt.family from srdb.assessment aa, srdb.stock bb, srdb.taxonomy tt, srdb.timeseries ts, srdb.assessor a
WHERE
a.mgmt = \'DFO\' AND
aa.assessorid = a.assessorid AND
