...
plot.CJFASfig1(par.estimates.1010, "mcont", "diff", "pre.positive==0","NWAtl","a",0.05) # 
plot.CJFASfig1(par.estimates.1010, "mcont", "diff", "pre.positive==0","NEAtl","b",0.05) #
plot.CJFASfig1(par.estimates.1010, "mcont", "diff", "pre.positive==0","NorthMidAtl","c",0.05) #
plot.CJFASfig1(par.estimates.1010, "mcont", "diff", "pre.positive==0","NEPac","d",0.05) #
plot.CJFASfig1(par.estimates.1010, "mcont", "diff", "pre.positive==0","Aust-NZ","e",0.04) #
plot.CJFASfig1(par.estimates.1010, "mcont", "diff", "pre.positive==0","HighSeas","f",0.015) #
