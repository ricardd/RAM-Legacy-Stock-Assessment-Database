...
## Last modified: Time-stamp: <2010-05-31 20:57:52 (srdbadmin)>
...
",sep="")
  ...
  ## get management body for each assessid
  qu <- paste("SELECT
a.assessid,
m.mgmt
FROM
...
mgmt.dat <- sqlQuery(chan, qu)
  ...
  crosshair.for.table.temp$ref <- paste("\\cite{", crosshair.for.table.temp$assessid, "}",sep="")
