...
# Daniel Ricard
# 2008-02-12: modifications to accomodate new Excel template
#
...
print("Processing the following Excel file: $ARGV[0] \n\n");
...
my ($sqlbiometrics, $bioid, $biounits, $biovalue); #, $biounique
...
$sqlbiometrics = qq{ INSERT INTO srdb.bioparams VALUES(\'$assessid\',\'$bioid\',\'$biovalue\') };
#print "$sqlbiometrics\n";
